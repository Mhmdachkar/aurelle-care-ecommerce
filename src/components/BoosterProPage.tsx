...
const boosterImages = [
  '/products/booster-pro/pink.png',
  '/products/booster-pro/black.png',
  '/products/booster-pro/model-1.jpg',
  '/products/booster-pro/led-colors.jpg',
  '/products/booster-pro/model-2.jpg',
